    ...
    public static class EspRenderer
    {
        public static void DrawAll()
        {
            ...
            if (boxOn)
            {
                ...
                try { BoxESP.DrawGl(); }
                catch (System.Exception e) { EntryPoint.Log("BoxESP.DrawGl 异常: " + e.Message); }
            ...
            if (boxOn)
            {
                ...
                catch (System.Exception e) { EntryPoint.Log("BoxESP.DrawLabels 异常: " + e.Message); }
            }
            if (lootOn)
            {
                try { LootESP.DrawLabels(); }
                catch (System.Exception e) { EntryPoint.Log("LootESP.DrawLabels 异常: " + e.Message); }
            }
        }
    }
}
